...
namespace WebAppLexicon.Models.Database
{
    internal class DbInitializer 
    {
        internal static async Task InitializeAsyn(
        ...
        
        {
            ...
            //------ Seed into database -----------------------------------------------------------
            {
                ...
                AppUser user = new AppUser()
                {
                    ...
                    EmailConfirmed = true,
                    PasswordHash = new PasswordHasher<IdentityUser>().HashPassword(null, "NeWY@8rs"),
                    FirstName = "Vicient",
                    LastName = "Kent",
                    SecurityStamp = Guid.NewGuid().ToString()
                };
