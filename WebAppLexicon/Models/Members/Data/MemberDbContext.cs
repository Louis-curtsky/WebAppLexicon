...
//    public class MemberDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Members>().HasData(
                new Members() { MemberId = 1, FirstName = "Giustina", LastName = "Gurnay", Phone = "108-553-0832", Gender = "Genderfluid", Age = 30, Nationality = "Panamanian", Email = "ggurnay0@opera.com", CntyId=1, StateId=1, CtyId=3, MemberApproval="Pending" },
                new Members() { MemberId = 2, FirstName = "Danita", LastName = "Kissick", Phone = "102-688-4545", Gender = "Female", Age = 76, Nationality = "Iroquois", Email = "dkissick1@clickbank.net", CntyId = 4, StateId = 8, CtyId = 7, MemberApproval = "Pending" },
                new Members() { MemberId = 3, FirstName = "Creigh", LastName = "Noice", Phone = "934-181-5000", Gender = "Male", Age = 35, Nationality = "Shoshone", Email = "cnoice2@wisc.edu", CntyId = 1, StateId = 1, CtyId = 3, MemberApproval = "Pending" },
                new Members() { MemberId = 4, FirstName = "Denis", LastName = "Hourihane", Phone = "260-684-7945", Gender = "Male", Age = 67, Nationality = "American Indian and Alaska Native (AIAN)", Email = "dhourihane3@toplist.cz", CntyId = 3, StateId = 10, CtyId = 10, MemberApproval = "Pending" },
                new Members() { MemberId = 5, FirstName = "Ariel", LastName = "Nattriss", Phone = "662-951-7611", Gender = "Male", Age = 62, Nationality = "Chickasaw", Email = "anattriss4@baidu.com", CntyId = 1, StateId = 2, CtyId = 2, MemberApproval = "Pending" },
                new Members() { MemberId = 6, FirstName = "Tommie", LastName = "Velte", Phone = "474-732-2163", Gender = "Male", Age = 35, Nationality = "Filipino", Email = "tvelte5@nps.gov", CntyId = 4, StateId = 8, CtyId = 7, MemberApproval = "Pending" },
                new Members() { MemberId = 7, FirstName = "Dennison", LastName = "Gonzales", Phone = "706-580-3696", Gender = "Male", Age = 40, Nationality = "Puerto Rican", Email = "dgonzales6@yelp.com", CntyId = 1, StateId = 1, CtyId = 3, MemberApproval = "Pending" },
                new Members() { MemberId = 8, FirstName = "Tynan", LastName = "Morphet", Phone = "298-108-6587", Gender = "Non-binary", Age = 56, Nationality = "White", Email = "tmorphet7@wix.com", CntyId = 3, StateId = 10, CtyId = 10, MemberApproval = "Pending" },
                new Members() { MemberId = 9, FirstName = "Mischa", LastName = "Foulstone", Phone = "853-913-7659", Gender = "Male", Age = 33, Nationality = "Menominee", Email = "mfoulstone8@narod.ru", CntyId = 2, StateId = 11, CtyId = 11, MemberApproval = "Pending" },
                new Members() { MemberId = 10, FirstName = "Lisa", LastName = "Olczak", Phone = "225-320-9656", Gender = "Female", Age = 49, Nationality = "Vietnamese", Email = "lolczak9@spiegel.de", CntyId = 1, StateId = 2, CtyId = 9, MemberApproval = "Pending" },
                new Members() { MemberId = 11, FirstName = "Rancell", LastName = "Gennings", Phone = "594-235-3927", Gender = "Genderfluid", Age = 38, Nationality = "Tlingit-Haida", Email = "rgenningsa@bloglines.com", CntyId = 2, StateId = 11, CtyId = 11, MemberApproval = "Pending" },
                new Members() { MemberId = 12, FirstName = "Kingsly", LastName = "Mongan", Phone = "805-257-2819", Gender = "Male", Age = 18, Nationality = "Yaqui", Email = "kmonganb@1und1.de", CntyId = 1, StateId = 2, CtyId = 2, MemberApproval = "Pending" },
                new Members() { MemberId = 13, FirstName = "Sayer", LastName = "Ortells", Phone = "201-214-9764", Gender = "Male", Age = 55, Nationality = "Honduran", Email = "sortellsc@yelp.com", CntyId = 2, StateId = 11, CtyId = 11, MemberApproval = "Pending" },
                new Members() { MemberId = 14, FirstName = "Abbie", LastName = "Knotte", Phone = "870-289-5196", Gender = "Male", Age = 32, Nationality = "Argentinian", Email = "aknotted@apache.org", CntyId = 4, StateId = 9, CtyId = 7, MemberApproval = "Pending" },
                new Members() { MemberId = 15, FirstName = "Vilma", LastName = "Puttrell", Phone = "176-399-0215", Gender = "Polygender", Age = 90, Nationality = "Laotian", Email = "vputtrelle@nytimes.com", CntyId = 4, StateId = 9, CtyId = 7, MemberApproval = "Pending" },
                new Members() { MemberId = 16, FirstName = "Amber", LastName = "Buffery", Phone = "716-926-5332", Gender = "Female", Age = 71, Nationality = "Chilean", Email = "abufferyf@jalbum.net", CntyId = 1, StateId = 1, CtyId = 3, MemberApproval = "Pending" },
